...
exports.alerts = (req, res, next) => {
  ...
  if (alert === 'booking')
    res.locals.alert =
      "Your booking was successfule! Please check your email for a confirmation.If your booking doesn't show up here immediately, please come back localStorage.";
  next();
};
